...
```{r testcodegg, eval = F, echo = F}
ggplot(motinv_sum, aes(x = Year, y = mean_count, fill = SpeciesCode,
                        color = SpeciesCode)) +
   geom_point() +
   geom_errorbar(aes(ymin = mean_count - se_counts,
                 ymax = mean_count + se_counts)) +
